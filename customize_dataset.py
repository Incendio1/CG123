...
feat_file_lst = ['./data_pre/gene_mutation/MF_BLCA_mutation_matrix.tsv',
                 './data_pre/gene_expression/GE_BLCA_expression_matrix.tsv',
                 './data_pre/DNA_methylation/METH_BLCA_methylation_RATIO_mean.tsv']
...
with open('./data/BLCA_5CV.pkl', 'wb') as f:
